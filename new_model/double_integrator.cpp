...
double* DoubleIntegrator::interiorPositionPartialFreeFinalState(double t_s, double x01, double x02, double x03, double x04, double x05, double x06, double x11, double x12, double x13)
{
  // prepare time vector
