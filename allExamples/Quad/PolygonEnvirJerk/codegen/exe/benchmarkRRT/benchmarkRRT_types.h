...
#ifndef struct_spF6LQLUoCEKIJjCXUKhKnG_tag
#define struct_spF6LQLUoCEKIJjCXUKhKnG_tag

struct spF6LQLUoCEKIJjCXUKhKnG_tag
{
  emxArray_real_T *f1;
};

#endif                                 /*struct_spF6LQLUoCEKIJjCXUKhKnG_tag*/

#ifndef typedef_cell_wrap_2
#define typedef_cell_wrap_2

typedef struct spF6LQLUoCEKIJjCXUKhKnG_tag cell_wrap_2;
