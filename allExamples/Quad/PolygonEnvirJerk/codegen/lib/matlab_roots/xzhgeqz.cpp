    ...
    do {
      ...
      if (jiter <= 30 * ((ihi - ilo) + 1) - 1) {
        ...
        if (ilast + 1 == ilo) {
          goto60 = true;
          b_guard1 = true;
        } else if (std::abs(b_A->data[ilast + b_A->size[0] * ilastm1].re) + std::
                   abs(b_A->data[ilast + b_A->size[0] * ilastm1].im) <= b_atol)
        {
          ...
          while ((!exitg2) && (j + 1 >= ilo)) {
            if (j + 1 == ilo) {
              guard3 = true;
              exitg2 = true;
            } else if (std::abs(b_A->data[j + b_A->size[0] * (j - 1)].re) + std::
                       abs(b_A->data[j + b_A->size[0] * (j - 1)].im) <= b_atol)
            {
          ...
          if (goto60) {
            ...
            if (goto70) {
              ...
              while ((!exitg2) && (j + 1 > ifirst)) {
                ...
                temp2 = ascale * (std::abs(b_A->data[jp1 + b_A->size[0] * j].re)
                                  + std::abs(b_A->data[jp1 + b_A->size[0] * j].
                  im));
                reAij = anorm;
                if (temp2 > anorm) {
                  reAij = temp2;
                ...
                if ((std::abs(b_A->data[j + b_A->size[0] * (j - 1)].re) + std::
                     abs(b_A->data[j + b_A->size[0] * (j - 1)].im)) * temp2 <=
                    anorm * b_atol) {
                  goto90 = true;
                  exitg2 = true;
                } else {
