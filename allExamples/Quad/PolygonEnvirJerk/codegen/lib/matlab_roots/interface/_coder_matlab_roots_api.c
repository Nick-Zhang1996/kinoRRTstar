...
void matlab_roots_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                      *plhs[1])
{
  emxArray_real_T *p;
...
void matlab_roots_atexit(void)
{
  ...
  matlab_roots_xil_terminate();
}

void matlab_roots_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
void matlab_roots_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_matlab_roots_api.c) */
