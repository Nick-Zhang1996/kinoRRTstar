 ...
 *
 * matlab_roots_emxAPI.h
 *
 * Code generation for function 'matlab_roots_emxAPI'
 *
 */

#ifndef MATLAB_ROOTS_EMXAPI_H
#define MATLAB_ROOTS_EMXAPI_H
...
/* End of code generation (matlab_roots_emxAPI.h) */
