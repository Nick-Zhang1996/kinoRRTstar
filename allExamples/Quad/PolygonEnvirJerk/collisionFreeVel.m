...
elseif collision_flag == 0 && dim ==3
    ...
    Tf = roots(quadf_timePFF(parent(1), parent(2), parent(3), parent(4), parent(5), parent(6), parent(7), parent(8), parent(9), node(1), node(2), node(3)));
    Tf = Tf(abs(imag(Tf)) < 0.0001);
    Tf = Tf(Tf >= 0);
    tf = Tf(1);
    cost = quadf_costPFF(Tf(1), parent(1), parent(2), parent(3), parent(4), parent(5), parent(6), parent(7), parent(8), parent(9), node(1), node(2), node(3));
    for i = 2 : length(Tf)
        costnow = quadf_costPFF(Tf(i), parent(1), parent(2), parent(3), parent(4), parent(5), parent(6), parent(7), parent(8), parent(9), node(1), node(2), node(3));
        if costnow<cost
            tf = Tf(i);
            cost = costnow;
        end
...
%     Tf = norm(parent(1 : 3) - node(1 : 3))/4;
    ...
    states = @(t)quadf_statePFF(t, Tf, parent(1), parent(2), parent(3), parent(4), parent(5), parent(6), parent(7), parent(8), parent(9), node(1), node(2), node(3));
    checkpoints = 10;
    ...
    xf = quadf_statePFFull(Tf, Tf, parent(1), parent(2), parent(3), parent(4), parent(5), parent(6), parent(7), parent(8), parent(9), node(1), node(2), node(3));
