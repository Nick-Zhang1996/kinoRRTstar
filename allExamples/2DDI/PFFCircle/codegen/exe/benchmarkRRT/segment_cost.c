...
void b_segment_cost(const double from_node_data[], double *cost, creal_T *Tf)
{
  double dv5[5];
  creal_T Tf_data[4];
  int Tf_size[1];
  ...
  double Mb;
  double Ma;
  DI_time(from_node_data[0], from_node_data[1], from_node_data[2],
  ...
  *cost = DI_cost(*Tf, from_node_data[0], from_node_data[1], from_node_data[2],
                  from_node_data[3], 18.0, 18.0, 0.0, 0.0);
}

void segment_cost(const double from_node[4], const double to_point[8], double
                  *cost, creal_T *Tf)
{
  double dv3[5];
  creal_T Tf_data[4];
  ...
  double Mb;
  double Ma;
  DI_time(from_node[0], from_node[1], from_node[2], from_node[3], to_point[0],
          to_point[1], to_point[2], to_point[3], dv3);
  ...
  *cost = DI_cost(*Tf, from_node[0], from_node[1], from_node[2], from_node[3],
                  to_point[0], to_point[1], to_point[2], to_point[3]);
}
