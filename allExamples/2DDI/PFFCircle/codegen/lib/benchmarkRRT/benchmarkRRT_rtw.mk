...
## Generated on : Mon Feb 22 00:55:45 2021
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: ./benchmarkRRT.lib
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = D:/Documents/GitHub/kinoRRTstar/allExamples/2DDI/PFFCircle/codegen/lib/benchmarkRRT
ARCH                      = win64
...
INCLUDES_BUILDINFO = -I$(START_DIR) -ID:/Documents/GitHub/kinoRRTstar/allExamples/2DDI/PFFCircle -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
SRCS = $(START_DIR)/benchmarkRRT_rtwutil.c $(START_DIR)/benchmarkRRT_data.c $(START_DIR)/benchmarkRRT_initialize.c $(START_DIR)/benchmarkRRT_terminate.c $(START_DIR)/benchmarkRRT.c $(START_DIR)/RRTstar3D.c $(START_DIR)/norm.c $(START_DIR)/xnrm2.c $(START_DIR)/sqrt.c $(START_DIR)/rand.c $(START_DIR)/eml_rand_mt19937ar_stateful.c $(START_DIR)/collisionFreeVel.c $(START_DIR)/DI_timeFreeVel.c $(START_DIR)/roots.c $(START_DIR)/anyNonFinite.c $(START_DIR)/xgehrd.c $(START_DIR)/xzlarfg.c $(START_DIR)/xdlapy3.c $(START_DIR)/recip.c $(START_DIR)/xzhseqr.c $(START_DIR)/xzgeev.c $(START_DIR)/xzlartg.c $(START_DIR)/xzhgeqz.c $(START_DIR)/linspace.c $(START_DIR)/DI_stateFreeVel.c $(START_DIR)/segment_cost.c $(START_DIR)/DI_time.c $(START_DIR)/DI_cost.c $(START_DIR)/benchmarkRRT_emxutil.c $(START_DIR)/rt_nonfinite.c $(START_DIR)/rtGetNaN.c $(START_DIR)/rtGetInf.c
...
%.obj : D:/Documents/GitHub/kinoRRTstar/allExamples/2DDI/PFFCircle/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : D:/Documents/GitHub/kinoRRTstar/allExamples/2DDI/PFFCircle/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
