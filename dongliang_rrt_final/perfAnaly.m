figure(4)
errorbar(mean(timeM(:, 2:14)), mean(costM(:, 2:14)), sqrt(0.9) * std(costM(:, 2:14)), ...
    sqrt(0.9) * std(costM(:, 2:14)), sqrt(0.9) * std(timeM(:, 2:14)), sqrt(0.9) * std(timeM(:, 2:14)), 'LineWidth', 1); hold on
