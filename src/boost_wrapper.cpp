...
BOOST_PYTHON_MODULE(kinoRRT){
  ...
  class_<OmplBenchmark>("OmplBenchmark", init<World&, Node&, Node&>())
    .def("solve", &OmplBenchmark::solve)
    .def("solveIncrementally", &OmplBenchmark::solveIncrementally)
    .def("getWaypoint", &OmplBenchmark::getWaypoint)
    .def("getWaypointCount", &OmplBenchmark::getWaypointCount)
    .def("getNodeCountHistPy", &OmplBenchmark::getNodeCountHistPy)
    .def("getMinCostHistPy", &OmplBenchmark::getMinCostHistPy)
    .def("getSolutionCountHistPy", &OmplBenchmark::getSolutionCountHistPy)
    ;
